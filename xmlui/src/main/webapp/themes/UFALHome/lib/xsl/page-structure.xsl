			...
			<div class="row">
				<div style="height: 160px; position: relative;" class="col-md-7 col-lg-7">
				  <a href="https://ilc4clarin.ilc.cnr.it/">
			            <img src="{$context-path}/themes/UFAL/images/lindat/ILC-CNR_for_CLARIN-IT_Logo.png" style="position: absolute; height: 60%; top: 0px; bottom: 0px; margin: auto;" class="logo" alt="ILC-CNR for CLARIN-IT logo" /></a>
				</div>
