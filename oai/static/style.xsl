...
<xsl:stylesheet version="1.0"
	...
	<xsl:template match="/">
		<html>
			<head>
                <title>ILC-CNR for CLARIN-IT OAI-PMH Data Provider Endpoint</title>
                ...
                <div class="container">
                    <div class="navbar navbar-default" role="navigation">
                        <div class="navbar-header">
                            <a class="navbar-brand" href="#">ILC-CNR for CLARIN-IT OAI-PMH Data Provider Endpoint</a>
                        </div>
                            ...
                            <ul class="nav navbar-nav navbar-right">
                                <li>
                                    <a title="Institutional information">
                                        ...
                                        <xsl:attribute name="href">
                                            <xsl:value-of
                                                    select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=Identify')"></xsl:value-of>
                                        </xsl:attribute>
                                        Identify
                                    </a>
                                </li>
                                <li>
                                    <a title="Listing available sets">
                                        ...
                                        <xsl:attribute name="href">
                                            <xsl:value-of
                                                    select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=ListSets')"></xsl:value-of>
                                        </xsl:attribute>
                                        Sets
                                    </a>
                                </li>
                                <li>
                                    <a title="Listing records (with metadata)">
                                        ...
                                        <xsl:attribute name="href">
                                            <xsl:value-of
                                                    select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=ListRecords&amp;metadataPrefix=oai_dc')"></xsl:value-of>
                                        </xsl:attribute>
                                        Records
                                    </a>
                                </li>
                                <li>
                                    <a title="Listing identifiers only">
                                        ...
                                        <xsl:attribute name="href">
                                            <xsl:value-of
                                                    select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=ListIdentifiers&amp;metadataPrefix=oai_dc')"></xsl:value-of>
                                        </xsl:attribute>
                                        Identifiers
                                    </a>
                                </li>
                                <li>
                                    <a title="Metadata Formats available">
                                        ...
                                        <xsl:attribute name="href">
                                            <xsl:value-of
                                                    select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=ListMetadataFormats')"></xsl:value-of>
                                        </xsl:attribute>
                                        Metadata Formats
                                    </a>
                                </li>
                ...
                <div class="list-group-item">
                    ...
                    <div class="spec">
                        <a>
                            <xsl:attribute name="href">
                                <xsl:value-of
                                        select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=ListRecords&amp;metadataPrefix=oai_dc&amp;set=', oai:setSpec/text())" />
                            </xsl:attribute>
                            Records
                        </a>
                        <a>
                            <xsl:attribute name="href">
                                <xsl:value-of
                                        select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=ListIdentifiers&amp;metadataPrefix=oai_dc&amp;set=', oai:setSpec/text())" />
                            </xsl:attribute>
                            Identifiers
                        </a>
                    </div>
                                ...
                                <xsl:for-each select="oai:header/oai:setSpec">
                                    <div class="list-group-item">
                                        <a>
                                            <xsl:attribute name="href">
                                                <xsl:value-of
                                                        select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=ListRecords&amp;metadataPrefix=oai_dc&amp;set=', text())" />
                                            </xsl:attribute>
                                            <xsl:value-of select="text()" />
                                        </a>
                                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <a class="btn btn-default pull-right">
                                <xsl:attribute name="href">
                                    <xsl:value-of select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=GetRecord&amp;metadataPrefix=oai_dc&amp;identifier=', oai:identifier/text())" />
                                </xsl:attribute>
                                View Details
                            </a>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <a class="btn btn-default pull-right">
                                <xsl:attribute name="href">
                                    <xsl:value-of
                                            select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=ListRecords&amp;metadataPrefix=', oai:metadataPrefix/text())" />
                                </xsl:attribute>
                                List Records
                            </a>
                        </div>
    ...
    <xsl:template match="oai:resumptionToken">
        <xsl:if test="text() != ''">
            <div class="text-center">
                ...
                <xsl:attribute name="href">
                    <xsl:value-of select="concat(/pippo/oai:OAI-PMH/oai:request/text(), '?verb=',/oai:OAI-PMH/oai:request/@verb,'&amp;resumptionToken=', text())"></xsl:value-of>
                </xsl:attribute>
                    Show More
                </a>
            </div>
